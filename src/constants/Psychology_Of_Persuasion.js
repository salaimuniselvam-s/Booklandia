export const PsychologyOfPersuasion = {
  title: "Psychology Of Persuasion",
  author: "Robert Cialdini",
  authorUrl: "https://en.wikipedia.org/wiki/Robert_Cialdini",
  summary:
  ...
  genres: ["Psychology", "Social Psychology", "Behavioral Psychology"],
  imgSrc: "Psychology_Of_Persuasion.jpg",
  description: [
  ...
  quotes: [
    ...
    "The art of persuasion is not in changing people's minds, but in understanding and working with the minds they already have.",
    ...
    "The key to successful communication is to take the perspective of the audience and speak to their needs, desires, and values.",

    "The greatest persuaders are those who seek to understand before seeking to be understood.",

    "Persuasion is not about manipulating others; it's about creating win-win situations and fostering mutually beneficial relationships.",

    "The art of persuasion lies in making the recipient feel that the decision they make is their own, even if it aligns with your desired outcome.",

    "True persuasion is achieved not by overpowering the mind, but by touching the heart.",
  ],
  Analogies: [
